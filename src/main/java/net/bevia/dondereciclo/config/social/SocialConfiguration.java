package net.bevia.dondereciclo.config.social;

import net.bevia.dondereciclo.repository.SocialUserConnectionRepository;
import net.bevia.dondereciclo.repository.CustomSocialUsersConnectionRepository;
import net.bevia.dondereciclo.security.social.CustomSignInAdapter;
