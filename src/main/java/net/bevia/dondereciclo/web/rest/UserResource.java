...
import net.bevia.dondereciclo.domain.User;
import net.bevia.dondereciclo.repository.AuthorityRepository;
import net.bevia.dondereciclo.repository.UserRepository;
import net.bevia.dondereciclo.security.AuthoritiesConstants;
import net.bevia.dondereciclo.service.MailService;
import net.bevia.dondereciclo.service.UserService;
import net.bevia.dondereciclo.web.rest.dto.ManagedUserDTO;
import net.bevia.dondereciclo.web.rest.dto.UserDTO;
import net.bevia.dondereciclo.web.rest.util.HeaderUtil;
import net.bevia.dondereciclo.web.rest.util.PaginationUtil;
